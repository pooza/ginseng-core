...
module Ginseng
  class URITest < TestCase
    ...
    # frozen な文字列を渡すと force_encoding が FrozenError になり、rescue に
    # 飲まれて「Can't convert String into String.」という無関係な TypeError に
    # 化けていた。Ruby 4 ではリテラルが frozen になりうるため踏みやすい。
    def test_normalize_component_accepts_frozen_string
      frozen = 'あ'.dup.freeze

      assert_equal('%E3%81%82', URI.normalize_component(frozen))
    end
